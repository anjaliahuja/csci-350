...
void test_print(){
	...
	Printf("Printing out random number between 20 and 30: %d\n", sizeof("Printing out random number between 20 and 30: %d\n"), random);
	random = Rand(10, 5);
		Printf("Printing out random number between 5 and 14: %d\n", sizeof("Printing out random number between 5 and 14: %d\n"), random);


	Write("Testing print syscall \n", sizeof("Testing print syscall \n"), ConsoleOutput);
	Printf("Printf is printing a string with one number: %d\n", sizeof("Printf is printing a string with one number: %d\n"), 1);
